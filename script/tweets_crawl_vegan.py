...
if __name__ == "__main__":
    ...
    tweets_crawling(CONSUMER_KEY, CONSUMER_SECRET, OAUTH_TOKEN, OAUTH_TOKEN_SECRET,hashtag='#vegan', tweet_mode='extended', lang='en', result_type='mixed', pagecount=100, items=100)
